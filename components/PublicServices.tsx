  ...
  return (
    <section className="bg-white py-20">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-5 xl:gap-12 items-start">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {services.map((service, index) => (
                <a key={index} href="#" className="flex items-center p-4 bg-most-secondary-bg rounded-lg border-2 border-transparent hover:border-most-red/80 hover:bg-red-50 transition-all transform hover:scale-[1.03] group">
          ...
          <div className="bg-most-secondary-bg p-8 rounded-lg mt-8 lg:mt-0">
            <h2 className="font-sans text-3xl font-extrabold mb-2 text-most-navy">Tra cứu Văn bản & Thủ tục</h2>
            <p className="text-gray-600 mb-6">Tìm kiếm trong cơ sở dữ liệu văn bản quy phạm pháp luật quốc gia.</p>
            <div className="space-y-4">
              <select className="w-full p-3 rounded-md bg-white border border-gray-300 focus:outline-none focus:ring-2 focus:ring-most-red appearance-none text-gray-700">
